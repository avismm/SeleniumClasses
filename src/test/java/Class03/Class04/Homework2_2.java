...
public class Homework2_2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        boolean femaleBtnDisplayState1 = femaleRadioButton.isDisplayed();
        if(femaleBtnDisplayState1){
...
//Finding the female radio button again and checking if it is now displayed and writing something in the console
        //WebElement radioBtn2=driver.findElement(By.xpath("//input[@value='gender-female' and contains(@name,'ident')]"));
        boolean femaleBtnDisplayState2 = femaleRadioButton.isDisplayed();
        if(femaleBtnDisplayState2){
            System.out.println("the radio button is displayed");
        }
        else{
            System.out.println("the radio button is not displayed");
